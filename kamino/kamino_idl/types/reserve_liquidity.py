...
class ReserveLiquidityJSON(typing.TypedDict):
    ...
    mint_decimals: int
    deposit_limit_crossed_timestamp: int
    borrow_limit_crossed_timestamp: int
...
class ReserveLiquidity:
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "deposit_limit_crossed_timestamp" / borsh.U64,
        "borrow_limit_crossed_timestamp" / borsh.U64,
    ...
    def from_decoded(cls, obj: Container) -> "ReserveLiquidity":
        return cls(
            ...
            deposit_limit_crossed_timestamp=obj.deposit_limit_crossed_timestamp,
            borrow_limit_crossed_timestamp=obj.borrow_limit_crossed_timestamp,
    ...
    def to_encodable(self) -> dict[str, typing.Any]:
        return {
            ...
            "deposit_limit_crossed_timestamp": self.deposit_limit_crossed_timestamp,
            "borrow_limit_crossed_timestamp": self.borrow_limit_crossed_timestamp,
