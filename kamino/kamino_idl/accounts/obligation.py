...
class ObligationJSON(typing.TypedDict):
    ...
    autodeleverage_margin_call_started_timestamp: int
    padding3: list[int]
...
class Obligation:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "autodeleverage_target_ltv_pct" / borsh.U8,
        "reserved" / borsh.U8[6],
        "highest_borrow_factor_pct" / borsh.U64,
        "autodeleverage_margin_call_started_timestamp" / borsh.U64,
        "padding3" / borsh.U64[125],
    )
    tag: int
    ...
    def decode(cls, data: bytes) -> "Obligation":
        ...
        return cls(
            ...
            autodeleverage_target_ltv_pct=dec.autodeleverage_target_ltv_pct,
            reserved=dec.reserved,
            highest_borrow_factor_pct=dec.highest_borrow_factor_pct,
            autodeleverage_margin_call_started_timestamp=dec.autodeleverage_margin_call_started_timestamp,
    ...
    def to_json(self) -> ObligationJSON:
        return {
            ...
            "autodeleverage_margin_call_started_timestamp": self.autodeleverage_margin_call_started_timestamp,
    ...
    def from_json(cls, obj: ObligationJSON) -> "Obligation":
        return cls(
            ...
            autodeleverage_target_ltv_pct=obj["autodeleverage_target_ltv_pct"],
            reserved=obj["reserved"],
            highest_borrow_factor_pct=obj["highest_borrow_factor_pct"],
            autodeleverage_margin_call_started_timestamp=obj[
